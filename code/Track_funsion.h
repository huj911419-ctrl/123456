...
#define INTER_ROUTE_REMAP_IP_ROW 60u              /* 路线重映射拐点行 */
#define INTER_ROUTE_REMAP_VALID_ROWS 30u          /* 路线重映射有效行数 */
#define INTER_ROUTE_EARLY_IP_ROW 60u              /* 路线早期复杂拐点行 */
#define INTER_ROUTE_EARLY_VALID_ROWS 48u          /* 路线早期有效行上限 */
#define INTER_ROUTE_EARLY_LA_MIN 12               /* 路线早期前瞻最小变化 */
#define INTER_ROUTE_EARLY_TREND_MIN 12            /* 路线早期趋势最小变化 */
#define INTER_COMPLEX_ARM_IP_ROW 58u              /* 复杂臂拐点行 */
...
#define IP_FAST_RA_ENABLE              1u

/* Fast scan only scans upper/middle image rows. */
#define IP_FAST_SCAN_TOP               10u
#define IP_FAST_SCAN_BOTTOM            42u
#define IP_FAST_SCAN_STEP              4u

/* Front road exists check. */
#define IP_FAST_FRONT_HALF_WIN         8
#define IP_FAST_FRONT_WHITE_MIN        4u
#define IP_FAST_FRONT_ROW_MIN          2u

/* Left/right branch check. */
#define IP_FAST_BRANCH_GAP             4
#define IP_FAST_BRANCH_MIN_LEN         14u
#define IP_FAST_BRANCH_ROW_MIN         2u

/* Continuous confirmation. */
#define IP_FAST_CONFIRM_FRAMES         2u
#define IP_FAST_LOST_DECAY_FRAMES      2u

/* Control inflection row. */
#define IP_CTRL_ROW_STEP               8u
#define IP_CTRL_ROW_DECAY              4u
#define IP_CTRL_ROW_MAX                85u

/* Control-row score. */
#define IP_CTRL_SCORE_MIN              55u
#define IP_CTRL_PRE_SCORE              20u
#define IP_CTRL_BRANCH_SCORE           45u
#define IP_CTRL_FRONT_LOST_SCORE       20u
#define IP_CTRL_BOTH_BRANCH_SCORE      60u
...
#else
#define RA_PRE_CONFIRM_FRAMES 2             /* debug: 2 frame confirm */
#endif             /* 预检测确认帧数 */
...
extern uint8 g_ip_visual_row;               /* 真实图像拐点行，等于 g_ip_max_row */
extern uint8 g_ip_ctrl_row;                 /* 控制用提前拐点行 */
extern uint8 g_ip_ctrl_dir;                 /* 控制用方向：1右，2左，3双侧/复杂 */
extern uint8 g_ip_ctrl_score;               /* 控制用置信分数 */
extern uint8 g_ip_ctrl_reason;              /* 触发原因 bit */
extern uint8 g_fast_ra_type;                /* 快速粗判类型：0无，1右直角，2左直角，5复杂 */
extern uint8 g_fast_ra_left;                /* 左侧有路 */
extern uint8 g_fast_ra_right;               /* 右侧有路 */
extern uint8 g_fast_ra_front;               /* 前方有路 */
