...
#define STEER_DIFF_STRAIGHT_PCT 95
...
#define STEER_RECENTER_T1 18
#define STEER_RECENTER_T2 46
#define STEER_RECENTER_MAX_PCT 150
...
#define SPEED_STRAIGHT_ERR_MAX 16
#define SPEED_STRAIGHT_LOOKAHEAD_MAX 18
#define SPEED_STRAIGHT_TREND_MAX 18
...
#define SPEED_STRAIGHT_HOLD_FRAMES 4u
#define SPEED_STRAIGHT_HOLD_VALID_ROWS 30u
#define SPEED_STRAIGHT_HOLD_ERR_MAX 24
#define SPEED_STRAIGHT_HOLD_LOOKAHEAD_MAX 28
#define SPEED_STRAIGHT_HOLD_TREND_MAX 28
#define SPEED_STRAIGHT_STEER_PCT 100
#define SPEED_LOOKAHEAD_SLOW_T1 4
#define SPEED_LOOKAHEAD_SLOW_T2 28
#define SPEED_LOOKAHEAD_MIN_PCT 80
#define SPEED_TREND_SLOW_T1 4
#define SPEED_TREND_SLOW_T2 24
#define SPEED_TREND_MIN_PCT 80
...
#define SPEED_VALID_RUSH_ERR_MAX 16
#define SPEED_VALID_RUSH_LA_MAX 18
#define SPEED_VALID_RUSH_TREND_MAX 18
#define SPEED_VALID_RUSH_PCT 92
#define SPEED_VALID_RUN_ROWS 42u
#define SPEED_VALID_RUN_ERR_MAX 24
#define SPEED_VALID_RUN_LA_MAX 28
#define SPEED_VALID_RUN_TREND_MAX 28
#define SPEED_VALID_RUN_MIN_PCT 76
#define SPEED_ERR_JUMP_T1 10
#define SPEED_ERR_JUMP_T2 28
#define SPEED_ERR_JUMP_MIN_PCT 82
...
#define RA_EXIT_CONFIRM_FRAMES   2u
#define RA_RECOVER_FIXED_FRAMES  2u
#define RA_RECOVER_SPEED_PCT     92
#define RA_RECOVER_LOST_SPEED_PCT 75
...
#define RA_RECOVER_MAX_FRAMES    8u
...
#define RA_RECOVER_NO_REVERSE_FRAMES 4u
#define RA_RECOVER_NO_REVERSE_RATE 260.0f
...
#define RA_EXIT_FIND_YAW_DEG    78.0f
#define RA_EXIT_FORCE_YAW_DEG   90.0f
...
#define RA_EXIT_LOST_OUTER_DUTY   850.0f
#define RA_EXIT_LOST_INNER_DUTY   650.0f
#define RA_FAST_DIRECT_YAW_OFFSET 0.0f
#define RA_HARD_YAW_MAX_DEG       92.0f
#define RA_HARD_YAW_PREDICT_MS    20.0f
#define RA_HARD_COAST_REMAIN_DEG 0.0f
#define RA_HARD_TIMEOUT_REMAIN_DEG 2.0f
#define RA_HARD_COAST_YAW_RATE 520.0f
#define RA_YAW_LOCK_FRAMES        3u
#define RA_YAW_LOCK_SPEED_PCT     70
...
#define RA_YAW_LOCK_RATE_DONE     260.0f
#define RA_YAW_LOCK_BRAKE_RATE    180.0f
#define RA_YAW_LOCK_BRAKE_KD      1.2f
#define RA_YAW_LOCK_BRAKE_MAX     600.0f
...
#define RA_CURVE_YAW_BRAKE_KP    55.0f
#define RA_CURVE_YAW_BRAKE_KD    1.1f
#define RA_CURVE_YAW_BRAKE_MAX   1200.0f
#define RA_RECOVER_YAW_BRAKE_MAX 520.0f
#define RA_SLOW_BEFORE_TURN_ROWS 32u
...
#define RA_APPROACH_SPEED_PCT    85
#define RA_HARD_INNER_DUTY       320.0f
#define RA_VOLT_COMP_ENABLE      1u
#define RA_VOLT_REF_X10          120u
#define RA_VOLT_COMP_MIN_PCT     90
#define RA_VOLT_COMP_MAX_PCT     112
#define RA_PIVOT_OUTER_MIN_DUTY  1200.0f
#define RA_COMPLEX_PIVOT_OUTER_MIN_DUTY 1500.0f
#define RA_PIVOT_TAPER_REMAIN_DEG 20.0f//什么时候开始收力(剩多少度)
#define RA_PIVOT_TAPER_MIN_PCT   18//收力最低收到多少(%)
#define RA_PIVOT_YAW_RATE_SOFT_LIMIT 380.0f////角速度上限(超过多少就开始压)
#define RA_PIVOT_YAW_RATE_MIN_PCT 32//收力最低收到多少(%)
#define RA_HARD_RATE_MIN          220.0f
#define RA_HARD_RATE_LIMIT        720.0f
#define RA_FAST_HARD_RATE_BOOST   60.0f
#define RA_COMPLEX_HARD_RATE_PCT  88
#define RA_HARD_RATE_TAPER_REMAIN_DEG 5.0f
#define RA_HARD_RATE_STOP_REMAIN_DEG 1.0f
#define RA_HARD_RATE_KP           3.0f
#define RA_HARD_DIFF_MAX_PCT      180
#define RA_HARD_BRAKE_DIFF_MAX    300.0f
#define RA_HARD_DIFF_SLEW_MAX     1100.0f
#define RA_HARD_LINE_TRIM_ENABLE 1u
...
#define RA_FAST_HARD_OUTER_PCT   105
...
#define RA_PRE_TURN_STEER_MAX    1050.0f
#define RA_PRE_TURN_SLEW_MAX     280.0f
#define RA_PRE_TURN_ENABLE       0
#define RA_PRE_TURN_STEER_GUARD_ENABLE 1u
#define RA_PRE_TURN_NORMAL_STEER_PCT 100
#define RA_PRE_TURN_GUARD_STEER_MIN 0.0f
#define RA_PRE_TURN_GUARD_STEER_MAX 420.0f
#define RA_PRE_TURN_GUARD_START_ROW 70u
#define RA_PRE_TURN_GUARD_ERR_MAX 32
#define RA_PRE_TURN_GUARD_LA_MAX 36
#define RA_COMPLEX_DUTY_PCT       100
#define RA_STRAIGHT_FRAMES       24u
#define RA_STRAIGHT_SPEED_PCT    100
#define RA_POST_RECOVER_FRAMES   3u
#define RA_POST_RECOVER_COMPLEX_FRAMES 12u
#define RA_POST_RECOVER_COMPLEX_SPEED_PCT 76
#define RA_POST_RECOVER_SPEED_PCT 95
...
#define CAS_POS_KP          0.72f
#define CAS_TREND_KD        0.86f
#define CAS_LA_K            0.78f
#define CAS_TARGET_MAX      180.0f
#define CAS_TARGET_FILTER   0.42f
#define CAS_YAW_KP_SCALE    0.13f
#define CAS_YAW_KD_SCALE    0.12f
#define CAS_DEADZONE_DPS    4.0f
