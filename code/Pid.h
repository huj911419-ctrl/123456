...
extern int16 ra_post_turn_gap_frames;
...
#define SPEED_LOOKAHEAD_MIN_PCT 45
#define SPEED_TREND_SLOW_T1 4
#define SPEED_TREND_SLOW_T2 24
#define SPEED_TREND_MIN_PCT 45
...
#define YAW_RATE_LIMIT 200.0f  /* yaw_rate 限幅阈值（度/秒），超过此值转向输出被压住 */
...
#define RA_POST_TURN_GAP_MAX_FRAMES 30u
#define RA_FAST_DIRECT_YAW_OFFSET 8.0f
#define RA_DIRECT_CAMERA_MIN_YAW  22.0f
#define RA_FAST_CAMERA_MIN_YAW    28.0f
#define RA_CROSS_HARD_YAW_DEG     42.0f
#define RA_CROSS_CAMERA_MIN_YAW   28.0f
#define RA_CAMERA_EXIT_TARGET_RATIO 0.70f
#define RA_HARD_TAPER_START_RATIO 0.55f
#define RA_HARD_TAPER_END_RATIO   0.86f
#define RA_HARD_TAPER_MIN_PCT     45
#define RA_FAST_HARD_TAPER_START_RATIO 0.60f
#define RA_FAST_HARD_TAPER_END_RATIO   0.90f
#define RA_FAST_HARD_TAPER_MIN_PCT     50
#define RA_HARD_YAW_RATE_SOFT_LIMIT 220.0f
#define RA_HARD_YAW_RATE_MIN_PCT    45
#define RA_HARD_COAST_REMAIN_DEG    3.0f
#define RA_HARD_COAST_YAW_RATE      130.0f
#define RA_DIRECT_TURN_ROW_OFFSET 0u
#define RA_COMPLEX_TURN_ROW_OFFSET 0u
#define RA_FAST_TURN_ROW_ADVANCE 8u
#define RA_FAST_TURN_ROW_ADVANCE_MAX 14u
#define RA_FAST_TURN_ROW_ADVANCE_SPEED_END 1400
#define RA_LOW_TURN_ROW_DELAY    1u
#define RA_LATE_APPROACH_SKIP_ROW_MARGIN 6u
#define RA_FAST_APPROACH_FRAMES  0u
