...
#define SPEED_QUALITY_ROW_MIN_PCT 92
...
#define SPEED_VALID_RUSH_PCT 105
#define SPEED_VALID_RUN_ROWS 42u
#define SPEED_VALID_RUN_MIN_PCT 90
...
#define SPEED_RAMP_STRAIGHT_UP_STEP 3200
...
#define YAW_RATE_LIMIT 200.0f  /* yaw_rate 限幅阈�（�/秒），超过��且�向同向加剧旋�时才衰减 */
#define YAW_RATE_LIMIT_MIN_PCT 35  /* yaw_rate 限幅�低保留百分比，防止真�道时�向�清�?*/

/* RA state timing, one frame is PID_PERIOD_MS. */
#define RA_HARD_TIMEOUT          14u
#define RA_FAST_SPEED_START      520
#define RA_FAST_HARD_TIMEOUT     18u
#define RA_CROSS_HARD_TIMEOUT    18u
#define RA_HARD_FORCE_TIMEOUT_EXTRA 12u
#define RA_HARD_EMERGENCY_TIMEOUT_EXTRA 18u
...
#define RA_RECOVER_LOST_SPEED_PCT 62
...
#define RA_RECOVER_YAW_TARGET_DEG 88.0f
...
#define RA_RECOVER_BRAKE_REMAIN_DEG 5.0f
#define RA_RECOVER_BRAKE_RATE     160.0f
#define RA_RECOVER_BRAKE_KD       2.8f
#define RA_RECOVER_BRAKE_MAX      1150.0f
#define RA_RECOVER_BRAKE_DUTY     1050.0f
#define RA_RECOVER_SEED_STEER_PCT 8
#define RA_FAST_DIRECT_YAW_OFFSET 0.0f
#define RA_HARD_YAW_MAX_DEG       86.0f
#define RA_HARD_YAW_PREDICT_MS    100.0f
#define RA_HARD_COAST_REMAIN_DEG 18.0f
#define RA_HARD_COAST_YAW_RATE 260.0f
#define RA_HARD_TAPER_START_RATIO 0.70f
#define RA_HARD_TAPER_END_RATIO   0.95f
#define RA_HARD_TAPER_MIN_PCT     68
#define RA_FAST_HARD_TAPER_START_RATIO 0.55f
#define RA_FAST_HARD_TAPER_END_RATIO   0.88f
#define RA_FAST_HARD_TAPER_MIN_PCT     52
#define RA_HARD_YAW_RATE_SOFT_LIMIT 280.0f
#define RA_HARD_YAW_RATE_MIN_PCT    62
#define RA_SLOW_BEFORE_TURN_ROWS 12u
#define RA_SLOW_TO_HARD_FALLBACK_FRAMES 5u
#define RA_APPROACH_SPEED_PCT    45
#define RA_HARD_INNER_DUTY       0.0f
#define RA_HARD_OUTER_PCT        94
#define RA_FAST_HARD_OUTER_PCT   94
#define RA_HARD_OUTER_MIN_DUTY   1600.0f
#define RA_COMPLEX_OUTER_MIN_DUTY 1650.0f
#define RA_DIRECT_TURN_ROW_OFFSET 0u
#define RA_COMPLEX_TURN_ROW_OFFSET 26u
#define RA_FAST_TURN_ROW_ADVANCE 16u
#define RA_FAST_TURN_ROW_ADVANCE_MAX 28u
...
#define RA_PRE_TURN_ROW_ADVANCE  16u
#define RA_PRE_TURN_ROW_SPAN     22u
#define RA_PRE_TURN_SPEED_END    1400
#define RA_PRE_TURN_STEER_MAX    650.0f
#define RA_PRE_TURN_SLEW_MAX     150.0f
#define RA_PRE_TURN_ENABLE       1
#define RA_COMPLEX_DUTY_PCT       100
#define RA_STRAIGHT_FRAMES       24u
#define RA_STRAIGHT_SPEED_PCT    100
#define RA_POST_RECOVER_FRAMES   18u
#define RA_POST_RECOVER_SPEED_PCT 72
...
#define LOST_SEARCH_ENTER_FRAMES 8u
#define LOST_SEARCH_SWITCH_FRAMES 45u
#define LOST_SEARCH_EXIT_VALID_ROWS 15u
#define LOST_SEARCH_DUTY 420.0f
#define LOST_SEARCH_FORWARD_DUTY 950.0f
