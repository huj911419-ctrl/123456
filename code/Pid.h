...
#define SPEED_FF_RATIO 0.45f
#define SPEED_ACCEL_FF_GAIN 0.35f
#define SPEED_ACCEL_FF_LIMIT 240.0f
...
#define SPEED_STRAIGHT_BOOST_PCT 115
...
#define SPEED_RAMP_UP_STEP 450
#define SPEED_RAMP_STRAIGHT_UP_STEP 1400
